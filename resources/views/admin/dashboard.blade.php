    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('admin.estructura.familias.index') }}" class="hlanz-btn-primary">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21h18M5 21V7l7-4 7 4v14M9 21v-4h6v4"></path></svg>
