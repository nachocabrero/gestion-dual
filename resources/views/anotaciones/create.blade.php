                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('anotaciones.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="puesto" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm w-full mt-1" name="puesto" type="number" min="1" max="30" value="{{ old('puesto') }}">
